...
<div class="container">
 ...
 <form id="reg" class="form-horizontal" action="index.php" method="POST">
 <div class="form-group">
 ...
 <input type="text" name="bday" class="form-control" id="bday">
 </div>

 <div class="form-group">
 <label for="exampleInputPassword2">Password</label>
 <input type="text" name="pass" class="form-control" id="exampleInputPassword2">
 </div>
 
 <div class="form-group">
 <label for="exampleInputPassword3">Password2</label>
 <input type="text" name="pass2" class="form-control" id="exampleInputPassword3">
 </div>
